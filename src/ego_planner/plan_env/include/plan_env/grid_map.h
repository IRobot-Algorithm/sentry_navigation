...
struct MappingData {
  ...
  std::vector<char> occupancy_buffer_inflate_segmentation_2d_;
  std::vector<double> terrain_height_;
  std::vector<bool> occupancy_buffer_clear_2d_;
...
public:
  ...
  void publishMap();
  void publishLocalMap2D();
  void publishGlobalMap2D();
...
private:
  ...
  ros::Publisher map_pub_, map_inf_pub_,local_map_2d_pub_,global_map_2d_pub_,terrain_height_pub_,map2d_pub_;
