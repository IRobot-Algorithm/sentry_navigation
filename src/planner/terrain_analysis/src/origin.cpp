...
int main(int argc, char** argv)
{
  ...
  while (status) {
    ...
    if (newlaserCloud) {
      ...
      terrainCloud->clear();
      for (int indX = terrainVoxelHalfWidth - 25; indX <= terrainVoxelHalfWidth + 25; indX++) {
        for (int indY = terrainVoxelHalfWidth - 25; indY <= terrainVoxelHalfWidth + 25; indY++) {
