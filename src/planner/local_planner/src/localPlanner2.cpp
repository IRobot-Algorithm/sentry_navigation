...
float searchRadius = 1.5;//0.45 1.5
...
// float searchRadius = 0.60;//0.45
// float gridVoxelOffsetX = 4.7;//3.2
// float gridVoxelOffsetY = 6.0;//4.5
// const int gridVoxelNumX = 236;//161
// const int gridVoxelNumY = 601;//451
...
int main(int argc, char** argv)
{
  ...
  //模拟发布path_index
  ros::Publisher pubindex = nh.advertise<std_msgs::Int16> ("/path_index", 5);
  std_msgs::Int16 index;
