...
private:
    ...
    bool ReLocationWithICP(Eigen::Isometry3d &trans ,const sensor_msgs::PointCloud2::ConstPtr &scan_msg, PointCloudT::Ptr &cloud_map_msg, const Eigen::Isometry3d &robot_pose);
    ...
    void ScanToPointCloudOnMap(const sensor_msgs::PointCloud2::ConstPtr &scan_msg, PointCloudT::Ptr &cloud_msg);
